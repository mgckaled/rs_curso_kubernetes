# Resumo: Bloco B - Conhecendo o HPA
...
## 2. Conhecendo a escala vertical
...
## 3. Explorando a escala horizontal
...
## 4. Como o Metrics-Server funciona
...
## 5. Adicionando o Metrics-Server no nosso Cluster
...
## 6. Entendendo os Principais Triggers
...
## 8. Criando o HPA Utilizando a V2
...
## 9. Estressando a Nossa Aplicação
...
## 10. Explorando mais cenários de estresse
...
## 11. Alterando Recursos e Réplicas da Aplicação
...
## 12. Definindo tempo de reação para escalonar a quantidade de réplicas
