# Resumo Bloco A - Conhecendo o Kubernetes

## Aulas

### 1. O Que É Kubernetes

Neste módulo, vamos explorar o Kubernetes, começando com uma base teórica antes de partir para a prática. É uma ferramenta poderosa, mas complexa, que orquestra containers, e entender seus trade-offs é essencial. O Kubernetes é agnóstico a provedores de nuvem e tecnologias de containers, e sua automação facilita a implantação de aplicações. Vamos discutir como ele se relaciona com conceitos anteriores, como CI/CD e IAC. Prepare-se para uma jornada que une teoria e prática!

### 2. Contexto inicial e problema
...
### 5. Como executar um Cluster Kubernetes
...
### 7. Configurando e criando nosso primeiro Cluster
...
### 8. Configurando Cluster com múltiplos nós
